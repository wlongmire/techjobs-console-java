        ...
        while (true) {
            ...
            if (actionChoice.equals("list")) {
                ...
                if (columnChoice.equals("all")) {
                    printJobs(JobDataComplete.findAll());
                } else {

                    ArrayList<String> results = JobDataComplete.findAll(columnChoice);
                ...
                if (searchField.equals("all")) {
                    ArrayList<HashMap<String, String>> jobs = JobDataComplete.findByValue(searchTerm);
                    printJobs(jobs);
                } else {
                    printJobs(JobDataComplete.findByColumnAndValue(searchField, searchTerm));
                }
            }
        }
    }
